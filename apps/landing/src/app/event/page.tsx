...
import { Calendar, MapPin, Clock, Megaphone, CreditCard } from 'lucide-react';
...
export default async function EventListPage() {
  const events = (await apiGet<EventItem[]>('/public/event?limit=20')) ?? [];
    ...
    <>
      ...
      <section className="py-12">
        <div className="container-page max-w-5xl mx-auto">
              ...
              {events.map((e) => (
                ...
                >
                  ...
                  <div className="flex-1 p-5 sm:py-5 sm:pl-1 sm:pr-6 min-w-0">
                    ...
                    {e.ringkasan && (
                      <p className="text-sm text-neutral-600 mb-3 line-clamp-2">{e.ringkasan}</p>
                    )}
          ...
          {/* Download CTA — no daftar di landing, arahkan ke aplikasi */}
